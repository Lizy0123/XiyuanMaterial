...
#import "XRFabuXuqiuViewController.h"
#import "XR_SecondViewController.h"


@interface XRFabuXuqiuViewController ()<UITextViewDelegate,UIGestureRecognizerDelegate,UITextFieldDelegate>
...
@implementation XRFabuXuqiuViewController
...
- (void)viewDidLoad {
    ...
    _backGroundScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, S_W, S_H-50-64)];
...
-(void)configUI{
    ...
    UIView *view1 = [[UIView alloc]initWithFrame:CGRectMake(0, 40, S_W, 70)];
    view1.backgroundColor = [UIColor whiteColor];
    [_backGroundScrollView addSubview:view1];
    
    UILabel *label11 = [[UILabel alloc]initWithFrame:CGRectMake(20, 7.5, 80, 20)];
    label11.text = @"需求标题";
    label11.font = [UIFont systemFontOfSize:13];
    label11.textColor = [UIColor blackColor];
    [view1 addSubview:label11];
    
    _textField1 = [[UITextField alloc]initWithFrame:CGRectMake(100, 7.5, S_W-100-20, 20)];
    ...
    _textField2 = [[UITextField alloc]initWithFrame:CGRectMake(100, 7.5+35, S_W-100-20, 20)];
    ...
    UILabel *label12 = [[UILabel alloc]initWithFrame:CGRectMake(20, 7.5+35, 80, 20)];
    label12.text = @"关键词";
    ...
    UIView *line1 = [[UIView alloc]initWithFrame:CGRectMake(0, 35, S_W, 0.3)];
    line1.backgroundColor = [UIColor groupTableViewBackgroundColor];
    [view1 addSubview:line1];
    
    UILabel *label2 = [[UILabel alloc]initWithFrame:CGRectMake(20, 120, S_W-40, 20)];
    label2.text = @"求购人信息";
    ...
    UIView *view2 = [[UIView alloc]initWithFrame:CGRectMake(0, 150, S_W, 105)];
    view2.backgroundColor = [UIColor whiteColor];
    [_backGroundScrollView addSubview:view2];
    
    UILabel *label21 = [[UILabel alloc]initWithFrame:CGRectMake(20, 7.5, 80, 20)];
    label21.text = @"联系地址";
    ...
    button3.frame = CGRectMake(100, 7.5, S_W-100-10, 20);
    ...
    UILabel *label22 = [[UILabel alloc]initWithFrame:CGRectMake(20, 7.5+35, 80, 20)];
    label22.text = @"联系电话";
    label22.font = [UIFont systemFontOfSize:13];
    label22.textColor = [UIColor blackColor];
    [view2 addSubview:label22];
    
    _textField3 = [[UITextField alloc]initWithFrame:CGRectMake(100, 7.5+35, S_W-100-20, 20)];
    ...
    UILabel *label23 = [[UILabel alloc]initWithFrame:CGRectMake(20, 7.5+70, 80, 20)];
    label23.text = @"电子邮箱";
    label23.font = [UIFont systemFontOfSize:13];
    label23.textColor = [UIColor blackColor];
    [view2 addSubview:label23];
    
    _textField4 = [[UITextField alloc]initWithFrame:CGRectMake(100, 7.5+35+35, S_W-100-20, 20)];
    ...
    for (int i = 0; i < 2; i++) {
        ...
        UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 35+35*i, S_W, 0.3)];
        view.backgroundColor = [UIColor groupTableViewBackgroundColor];
        [view2 addSubview:view];
    }
    
    UIView *view3 = [[UIView alloc]initWithFrame:CGRectMake(0, 280, S_W, 160)];
    view3.backgroundColor = [UIColor whiteColor];
    [_backGroundScrollView addSubview:view3];
    
    UILabel *label31 = [[UILabel alloc]initWithFrame:CGRectMake(20, 7.5, 80, 20)];
    label31.text = @"需求详情";
    ...
    _textView1 = [[MyTextView alloc]initWithFrame:CGRectMake(100, 7.5, S_W-100-20, 160-15)];
    ...
    _backGroundScrollView.contentSize = CGSizeMake(S_W, 545);
...
- (void)keyboardWillShow:(NSNotification *)notification {
    ...
    if(offset > 0) {
        ...
        _backGroundScrollView.contentSize = CGSizeMake(self.view.bounds.size.width,545+offset);
...
- (void)keyboardWillHide:(NSNotification *)notify {
    ...
    _backGroundScrollView.contentSize = CGSizeMake(self.view.bounds.size.width,545);
...
-(void)configBottomBtn{
    ...
    _bottomButton.frame = CGRectMake(0, S_H-50-64, S_W, 50);
    _bottomButton.backgroundColor = [UIColor magentaColor];
    [_bottomButton setTitle:@"提交" forState:UIControlStateNormal];
    [_bottomButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [_bottomButton setBackgroundImage:[UIImage imageNamed:@"sendBuyMessage"] forState:UIControlStateNormal];
    [_bottomButton addTarget:self action:@selector(next) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:_bottomButton];
}
#pragma mark - 选择产品地区
-(void)choseProductAddress{
    NSLog(@"选择地区");
    XR_SecondViewController *address = [[XR_SecondViewController alloc]init];
...
-(void)next{
    ...
    __weak typeof(self)weakSelf = self;
    NSString *url = [requestUrlHeader stringByAppendingString:fabuXuqiuUrl];
    NSLog(@"url====%@",url);
