...
@implementation X_JJTableViewCell
...
-(void)setModel:(X_JingJiaGongGaoModel *)model
{
    ...
    if (model.tnDeposit) {
        ...
        // 创建Attributed
        NSMutableAttributedString *noteStr1 = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@ 元",[MyHelper moneyStyle:model.tnDeposit]]];
        // 需要改变的区间
...
//    if (model.picUrl) {
//        
//        NSString *picUrl = [picUrlHeader stringByAppendingString:model.picUrl];
//        [self.imageV sd_setImageWithURL:[NSURL URLWithString:picUrl] placeholderImage:[UIImage imageNamed:@"icon_defaultPic"]];
//    }
//    else{
//        
