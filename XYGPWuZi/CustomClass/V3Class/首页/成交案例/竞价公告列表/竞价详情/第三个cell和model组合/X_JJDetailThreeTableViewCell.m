...
//    }
    ...
    if (model.tsMinPrice == nil) {
        ...
        self.qpjLabel.text = [NSString stringWithFormat:@"%@ 元",[MyHelper moneyStyle:model.tsMinPrice]];
        // 创建Attributed
    ...
    if (model.tsAddPrice == nil) {
        ...
        self.jjtdLabel.text = [NSString stringWithFormat:@"%@ 元",[MyHelper moneyStyle:model.tsAddPrice]];
        // 创建Attributed
    ...
    if (model.tsProtectPrice == nil) {
        ...
        /*
        self.xsdjLabel.text = [NSString stringWithFormat:@"%@ 元",[MyHelper moneyStyle:model.tsProtectPrice]];
        // 创建Attributed
    ...
    if (model.tsEndPrice == nil) {
        ...
        self.cjjgLabel.text =  [NSString stringWithFormat:@"%@ 元",[MyHelper moneyStyle:model.tsEndPrice]];
        // 创建Attributed
