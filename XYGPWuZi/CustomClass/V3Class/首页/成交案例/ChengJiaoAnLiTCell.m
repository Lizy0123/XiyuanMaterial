...
@implementation ChengJiaoAnLiTCell
...
-(void)setModel:(ChengJiaoAnLiModel *)model{
    ...
    if (model.tsEndPrice) {
        // 创建Attributed
        NSMutableAttributedString *noteStr1 = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@ 元",[NSObject moneyStyle:model.tsEndPrice]]];
        // 需要改变的区间
