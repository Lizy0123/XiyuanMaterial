...
-(void)layoutSubviews
{
    ...
    searchField.tintColor= kColorNav;
    //
...
-(UIButton*)categoryBtn{
    if (!_categoryBtn) {
        ...
        [_categoryBtn setTitleColor:kColorNav forState:UIControlStateNormal];
        [_categoryBtn setTitle:@"公告" forState:UIControlStateNormal];
    }
    return _categoryBtn;
}
