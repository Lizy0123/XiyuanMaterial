...
#define SLIP_ORIGIN_FRAME CGRectMake(SCREEN_WIDTH, kSafeAreaTopHeight, SCREEN_WIDTH - _sideSlipLeading, SCREEN_HEIGHT-kSafeAreaTopHeight-kSafeAreaBottomHeight)
#define SLIP_DISTINATION_FRAME CGRectMake(_sideSlipLeading, kSafeAreaTopHeight, SCREEN_WIDTH - _sideSlipLeading, SCREEN_HEIGHT-kSafeAreaTopHeight-kSafeAreaBottomHeight)
...
- (void)show {
    ...
    [ap.keyWindow addSubview:self.backCover];
    [ap.keyWindow addSubview:self.navigationController.view];
...
- (UIView *)createBottomView {
    ...
    [resetButton setBackgroundColor:[UIColor hexColor:FILTER_RED_STRING]];
    ...
    [commitButton setBackgroundColor:kColorNav];
