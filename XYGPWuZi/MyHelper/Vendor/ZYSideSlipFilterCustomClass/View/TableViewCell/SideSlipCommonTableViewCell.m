...
#define NUM_OF_ITEM_ONCE_ROW 4.f
...
- (void)configureCell {
    ...
    _mainCollectionView.contentInset = UIEdgeInsetsMake(0, 8, 0, 8);
...
- (void)updateCellWithModel:(ZYSideSlipFilterRegionModel **)model indexPath:(NSIndexPath *)indexPath {
    ...
    if (_regionModel.itemList.count > 3) {
        //icon
        ...
        [_controlIcon setHidden:YES];
        [_controlLabel setHidden:YES];
    }
